        ...
        <div className="flex items-center gap-3 min-w-0">
          ...
          <div className="min-w-0">
            ...
            <div className="flex items-center gap-1.5">
              ...
              <span className="text-[11px] text-slate-400">{steps.length} pagine</span>
              {funnel.brand_name && (
                <>
                  <span className="text-slate-300">&middot;</span>
      ...
      >
        ...
        >
          ...
          <div className="absolute flex flex-col items-center gap-1" style={{ left: startNode.x, top: startNode.y }}>
            ...
            <span className="text-[9px] font-medium text-slate-500">Ingresso</span>
          </div>
          ...
          {endNode && (
            <div className="absolute flex flex-col items-center gap-1" style={{ left: endNode.x, top: endNode.y }}>
              ...
              <span className="text-[9px] font-medium text-slate-500">Fine</span>
            </div>
          )}
              ...
              >
                ...
                >
                  ...
                  >
                    ...
                    <p className="flex-1 text-xs font-semibold text-slate-700 truncate">{step.title || 'Senza titolo'}</p>
                    {step.url && (
                      <a
                        href={step.url}
                        target="_blank"
                  ...
                  >
                    {step.url ? (
                      ...
                      <div className="flex flex-col items-center justify-center h-full bg-slate-50">
                        ...
                        <p className="mt-1 text-[8px] text-slate-400">Nessun URL</p>
                      </div>
                    )}
                  </div>
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3">
            <span className="text-[11px] text-slate-400 flex items-center gap-1">
              ...
              Trascina i blocchi &middot; Scroll per zoom &middot; +/- da tastiera &middot; 0 per reset
            </span>
          ...
          <div className="absolute top-14 right-4 w-72 bg-white rounded-xl border border-slate-200 shadow-xl z-40 overflow-hidden">
            ...
            <div className="p-3 space-y-2 max-h-60 overflow-y-auto">
              ...
              {s.options && s.options.length > 0 && (
                <div>
                  <p className="text-[9px] text-slate-400 uppercase tracking-wider mb-1">Opzioni</p>
