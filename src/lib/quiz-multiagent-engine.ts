...
export async function runVisualDesignAgent(
  ...
  onProgress?.('Agent Visual: analisi design pixel-perfect...');
  ...
  onProgress?.('Agent Visual: completato');
...
export async function runUXFlowAgent(
  ...
  onProgress?.('Agent UX Flow: analisi flusso e interazioni...');
  ...
  onProgress?.('Agent UX Flow: completato');
...
export async function runCROAgent(
  ...
  onProgress?.('Agent CRO: analisi copy e strategia conversione...');
  ...
  onProgress?.('Agent CRO: completato');
...
export async function runQuizLogicAgent(
  ...
  onProgress?.('Agent Quiz Logic: reverse-engineering meccanica quiz...');
  ...
  onProgress?.('Agent Quiz Logic: completato');
...
export async function runSynthesisAgent(
  ...
  onProgress?.('Agent Synthesis: unificazione e validazione...');
  ...
  onProgress?.('Agent Synthesis: completato');
...
export async function runMultiAgentAnalysis(input: MultiAgentInput): Promise<MultiAgentResult> {
  ...
  progress('parallel_agents', 'Lancio 4 agenti Gemini in parallelo...');
