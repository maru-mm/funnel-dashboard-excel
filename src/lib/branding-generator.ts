...
/**
 * Genera un branding completo a partire da un prodotto e un funnel di riferimento.
 *
 * @param input - Prodotto, funnel di riferimento, e opzioni
 * @returns Il branding generato pronto per essere applicato al swipe
 */
...
/**
 * Helper: costruisce l'input per generateBranding a partire da dati del DB.
 * Converte i FunnelCrawlStepRow in BrandingReferenceFunnelStep.
 */
