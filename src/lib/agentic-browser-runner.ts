 ...
 *
 * Agent loop:
 * 1. Naviga alla entry URL
 * 2. Screenshot → Gemini Computer Use → azioni (click, type, scroll, ecc.)
 * 3. Playwright esegue le azioni con coordinate denormalizzate
 * 4. Screenshot → invia come function_response → ripeti
 * 5. Fino a checkout / fine funnel / max step
 *
...
/**
 * Esegue una singola azione Computer Use su Playwright.
 * Le coordinate sono normalizzate (0-999) e vengono denormalizzate
 * alle dimensioni reali dello schermo.
 */
