...
export default function FirecrawlPage() {
  ...
  const getActionDescription = (a: FirecrawlAction) => {
    switch (a) {
      case 'scrape': return 'Estrae contenuto da una singola pagina';
      case 'crawl': return 'Crawla un sito seguendo i link';
      case 'map': return 'Mappa tutte le URL di un sito';
    }
  };
      ...
      return (
        <div className="space-y-4">
          <div className="bg-gray-50 rounded-lg p-4">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-sm">
              ...
              {crawlData.creditsUsed && (
                <div>
                  <span className="text-gray-500">Crediti usati:</span>
          ...
          {crawlData.data && crawlData.data.length > 0 && (
            <div className="bg-gray-50 rounded-lg p-4">
              <h4 className="font-semibold text-gray-900 mb-3">Pagine Crawlate ({crawlData.data.length})</h4>
  ...
  return (
    <div className="min-h-screen">
      <Header
        ...
        subtitle="Scraping, Crawling e Swipe con Firecrawl"
      />
      ...
      <div className="p-6 max-w-6xl mx-auto">
          ...
          <>
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-purple-800 text-sm mt-1">
                    Inserisci l&apos;URL di una landing page e i dati del tuo prodotto. L&apos;API userà Firecrawl 
                    per estrarre il contenuto e poi lo &quot;swiperà&quot; sostituendo le informazioni con quelle del tuo prodotto.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6 mb-6">
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    <input
                      ...
                      placeholder="https://landing-page-da-copiare.com"
                    />
                  </div>
                  ...
                  <div className="border-t pt-4">
                    ...
                    <div className="space-y-3">
                      <div>
                        <label className="block text-sm text-gray-600 mb-1">Nome Prodotto *</label>
                        <input
                          type="text"
                ...
                <div className="space-y-4">
                  <div>
                    <label className="block text-sm text-gray-600 mb-1">Testo CTA</label>
                    <input
                      type="text"
                  ...
                  <div>
                    <label className="block text-sm text-gray-600 mb-1">Benefici</label>
                    ...
                    <div className="space-y-1.5 max-h-[200px] overflow-auto">
                      ...
                      {swipeProduct.benefits.filter(b => b.trim() !== '').length === 0 && (
                        <p className="text-sm text-gray-400 italic">Nessun beneficio aggiunto</p>
                      )}
                    </div>
                  </div>
                </div>
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <h3 className={`font-semibold ${swipeResponse.success ? 'text-green-900' : 'text-red-900'}`}>
                        {swipeResponse.success ? 'Swipe Completato!' : 'Errore Swipe'}
                      </h3>
                  ...
                  {swipeResponse.success && swipeResponse.html && (
                    <div className="flex items-center gap-2">
                      ...
                      >
                        ...
                        {showSwipePreview ? 'Nascondi' : 'Preview'}
                      </button>
                      <button
                      ...
                      {swipeResponse.changes_made && swipeResponse.changes_made.length > 0 && (
                        <div className="bg-green-50 rounded-lg p-4">
                          <h4 className="font-medium text-green-900 mb-2 flex items-center gap-2">
                            ...
                            Modifiche Effettuate ({swipeResponse.changes_made.length})
                          </h4>
                      ...
                      {showSwipePreview && swipeResponse.html && (
                        <div className="border border-gray-300 rounded-lg overflow-hidden">
                          <div className="bg-gray-100 px-4 py-2 border-b flex items-center justify-between">
                            <span className="text-sm font-medium text-gray-700">Preview HTML Swipato</span>
                            <a
                            ...
                            >
                              Originale <ExternalLink className="w-3 h-3" />
                            </a>
                          </div>
                          <iframe
                      ...
                      {!showSwipePreview && swipeResponse.html && (
                        <div className="bg-gray-900 rounded-lg p-4 overflow-auto max-h-[400px]">
                          <pre className="text-green-400 text-xs font-mono whitespace-pre-wrap">
                            ...
                            {swipeResponse.html.length > 5000 && '\n\n... (troncato, scarica per il contenuto completo)'}
                          </pre>
                        </div>
                      )}
                    </div>
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-orange-800 text-sm mt-1">
                    Usa questa dashboard per testare le API Firecrawl. Inserisci la tua API key e un URL per 
                    effettuare scraping, crawling o mapping di siti web.
                  </p>
                </div>
              </div>
            </div>
        ...
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6 mb-6">
          ...
          <p className="text-xs text-gray-500 mt-2">
            La chiave non viene salvata e viene usata solo per questa sessione.
          </p>
        </div>
        ...
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6 mb-6">
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div className="lg:col-span-2">
              <label className="block text-sm font-medium text-gray-700 mb-2">URL da {action === 'scrape' ? 'estrarre' : action === 'crawl' ? 'crawlare' : 'mappare'}</label>
              <input
                type="url"
                value={url}
              ...
              {showOptions && (
                <div className="mt-4 p-4 bg-gray-50 rounded-lg space-y-4">
                    ...
                    <>
                      <div className="flex items-center gap-4">
                        <label className="flex items-center gap-2">
                          ...
                          />
                          <span className="text-sm">Solo contenuto principale</span>
                        </label>
                      </div>
                      <div>
                        <label className="block text-sm text-gray-600 mb-1">Formati output</label>
                        <div className="flex gap-2">
                  ...
                  {action === 'crawl' && (
                    <>
                      <div className="grid grid-cols-2 gap-4">
                        <div>
                          <label className="block text-sm text-gray-600 mb-1">Limite pagine</label>
                          <input
                            type="number"
                            value={options.limit}
                      ...
                      <div className="flex items-center gap-4">
                        <label className="flex items-center gap-2">
                          <input
                            ...
                            className="rounded border-gray-300"
                          />
                          <span className="text-sm">Link esterni</span>
                        </label>
                        <label className="flex items-center gap-2">
                          <input
                            type="checkbox"
                            ...
                            className="rounded border-gray-300"
                          />
                          <span className="text-sm">Link all&apos;indietro</span>
                        </label>
                      </div>
                    </>
                  )}
                  ...
                  {action === 'map' && (
                    <>
                      <div>
                        <label className="block text-sm text-gray-600 mb-1">Cerca (filtro URL)</label>
                        <input
                          type="text"
                          value={options.search}
                          onChange={(e) => setOptions({ ...options, search: e.target.value })}
                          className="w-full px-3 py-1.5 border border-gray-300 rounded text-sm"
                          placeholder="es: blog, product"
                        />
                      </div>
                      <div>
                        <label className="block text-sm text-gray-600 mb-1">Limite URL</label>
                        <input
                          type="number"
                          value={options.limit}
                      ...
                      <div className="flex items-center gap-4">
                        <label className="flex items-center gap-2">
                          <input
                            ...
                            className="rounded border-gray-300"
                          />
                          <span className="text-sm">Includi sottodomini</span>
                        </label>
                        <label className="flex items-center gap-2">
                          <input
                            type="checkbox"
                            ...
                            className="rounded border-gray-300"
                          />
                          <span className="text-sm">Ignora sitemap</span>
                        </label>
                      </div>
                    </>
                  )}
              ...
              >
                {isLoading ? (
                  ...
                  <>
                    ...
                    Esegui {action.charAt(0).toUpperCase() + action.slice(1)}
                  </>
                )}
              </button>
            </div>
          ...
          <div className="bg-white rounded-lg shadow-sm border border-gray-200 overflow-hidden">
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h3 className={`font-semibold ${response.success ? 'text-green-900' : 'text-red-900'}`}>
                    {response.success ? 'Richiesta completata' : 'Errore'}
                  </h3>
                  {response.duration && (
                    <p className="text-sm text-gray-600 flex items-center gap-1">
                      <Clock className="w-3 h-3" />
            ...
            <div className="p-6">
              {response.error ? (
                ...
                <p className="text-gray-500">Nessun dato nella risposta</p>
              )}
            </div>
          </div>
        )}
