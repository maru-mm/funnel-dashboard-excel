...
const PLATFORM_CONFIG: Record<Platform, { label: string; color: string; bgColor: string; description: string }> = {
  ...
  funnelish: {
    ...
    description: 'Import HTML page via Custom HTML element nel funnel builder',
  },
};
...
export default function DeployFunnelPage() {
  ...
  return (
    <div className="flex-1 flex flex-col min-h-screen bg-gray-50">
      <Header
        title="Deploy Funnel"
        subtitle="Importa pagine HTML su Checkout Champ e Funnelish"
      />
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white rounded-xl border border-gray-200 p-6 space-y-4">
              ...
              <div className="flex gap-3">
                <label className="flex-1 flex items-center justify-center gap-2 p-4 border-2 border-dashed border-gray-300 rounded-lg cursor-pointer hover:border-blue-400 hover:bg-blue-50 transition-colors">
                  ...
                  <span className="text-sm text-gray-600">
                    {html ? `${(html.length / 1024).toFixed(1)} KB caricato` : 'Carica file HTML'}
                  </span>
                  <input
                    type="file"
                    accept=".html,.htm"
              ...
              <div className="relative">
                <textarea
                  ...
                  placeholder="Incolla qui il codice HTML oppure carica un file..."
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  ...
                  <input
                    ...
                    placeholder="es. Quiz Weight Loss IT"
                ...
                <div>
                  ...
                  <input
                    ...
                    placeholder="es. Landing Page v2"
                    className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                  />
                </div>
                <div>
            ...
            <div className={`rounded-xl border p-6 space-y-4 ${PLATFORM_CONFIG[platform].bgColor}`}>
              <h3 className={`font-semibold flex items-center gap-2 ${PLATFORM_CONFIG[platform].color}`}>
                ...
                Credenziali {PLATFORM_CONFIG[platform].label}
              </h3>
              ...
              {platform === 'checkout_champ' && (
                <label className="flex items-center gap-2 cursor-pointer">
                  ...
                  <span className="text-sm text-gray-700">
                    Inietta tracking script (Import Click automatico)
                  </span>
                </label>
              )}
            </div>
            ...
            {showAdvanced && (
              <div className="bg-white rounded-xl border border-gray-200 p-6">
                <label className="flex items-center gap-2 cursor-pointer">
                  ...
                  />
                  <span className="text-sm text-gray-700">
                    Headless mode (browser invisibile, piu veloce)
                  </span>
                </label>
              </div>
            )}
            ...
            >
              {deploying ? (
                <>
                  ...
                  Deploying su {PLATFORM_CONFIG[platform].label}...
                </>
              ) : (
                <>
                  <Rocket className="w-5 h-5" />
                  Deploy su {PLATFORM_CONFIG[platform].label}
                </>
              )}
            </button>
          </div>
          ...
          <div className="space-y-6">
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h3 className={`font-bold text-lg ${result.success ? 'text-green-800' : 'text-red-800'}`}>
                    {result.success ? 'Deploy completato!' : 'Deploy fallito'}
                  </h3>
            ...
            <div className="bg-white rounded-xl border border-gray-200">
              <div className="px-4 py-3 border-b border-gray-100 flex items-center gap-2 text-sm font-medium text-gray-700">
                ...
                Log automazione ({result.steps.length} step)
              </div>
