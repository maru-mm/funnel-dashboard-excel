...
export default function PromptsPage() {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <Header
        title="My Prompts"
        subtitle="Salva e gestisci i tuoi prompt riutilizzabili in tutte le pagine"
      />
            ...
            <div className="space-y-4">
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                  ...
                  <input
                    ...
                    placeholder="Es: Swipe Advertorial Italiano"
              ...
              <div>
                ...
                <textarea
                  ...
                  rows={6}
                  placeholder="Scrivi il tuo prompt qui... Puoi usare variabili come {product_name}, {brand_name}, {benefits}, ecc."
        ...
        {loading ? (
          ...
          <div className="bg-white rounded-2xl border border-gray-200 p-12 text-center">
            ...
            <p className="text-sm text-gray-400 mb-4">
              {prompts.length === 0
                ? 'Crea il tuo primo prompt per iniziare!'
                      ...
                      <div className="flex items-start justify-between gap-4">
                        <div className="flex-1 min-w-0">
                          ...
                          <div className="flex items-center gap-4 mt-2 text-xs text-gray-400">
                            <span>Usato {prompt.use_count}x</span>
                            <span>
                              {new Date(prompt.updated_at).toLocaleDateString('it-IT')}
                            </span>
                          </div>
                        </div>
                        ...
                        <div className="flex items-center gap-1.5 shrink-0">
                          <button
                            ...
                            title={prompt.is_favorite ? 'Rimuovi preferito' : 'Aggiungi preferito'}
                          >
                            <Star
                              className="w-4 h-4"
