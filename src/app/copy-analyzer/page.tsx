...
export default function CopyAnalyzerPage() {
  ...
  return (
    <div className="min-h-screen">
      <Header 
        title="Copy Analyzer" 
        subtitle="Analizza le headline delle landing page con AI" 
      />
          ...
          <div className="flex items-center gap-3 mb-4">
            ...
            <div>
              ...
              <p className="text-sm text-gray-500">
                Inserisci l&apos;URL di una landing page per analizzare la headline
              </p>
            </div>
          </div>
        ...
        {isLoading && (
          <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-12 text-center">
            ...
            <p className="text-gray-500 mt-2">
              Sto estraendo la headline e analizzandola con AI
            </p>
          </div>
        )}
          ...
          <div className="bg-blue-50 border border-blue-200 rounded-xl p-6">
            ...
            <ol className="space-y-2 text-blue-800 text-sm">
              <li className="flex items-start gap-2">
                ...
                <span>Inserisci l&apos;URL completo della landing page che vuoi analizzare</span>
              </li>
              <li className="flex items-start gap-2">
                ...
                <span>Il sistema estrarrà automaticamente la headline principale (H1, title, og:title)</span>
              </li>
              <li className="flex items-start gap-2">
                ...
                <span>L&apos;AI analizzerà la headline e ti fornirà feedback dettagliato</span>
              </li>
            </ol>
          </div>
        )}
