  ...
  try {
    ...
    return NextResponse.json({
      ...
      message: allTablesExist 
        ? 'Tutte le tabelle sono configurate correttamente!' 
        : 'Alcune tabelle mancano. Esegui lo schema SQL in Supabase.',
    ...
    return NextResponse.json({
      ...
      message: 'Errore durante il test della connessione Supabase',
    }, { status: 500 });
  }
}
