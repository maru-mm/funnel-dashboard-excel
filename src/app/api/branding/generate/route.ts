 ...
 *
 * Genera un branding completo per un prodotto partendo dall'analisi
 * di un funnel di riferimento (quiz o standard).
 *
 * Supporta due modalità:
 *
 * 1. MODALITA' DB — Passa productId + funnelName/entryUrl e il sistema
 *    carica automaticamente i dati dal database:
 *    {
 *      "productId": "uuid",
 ...
 *    }
 *
 * 2. MODALITA' DIRETTA — Passa l'input completo:
 *    {
